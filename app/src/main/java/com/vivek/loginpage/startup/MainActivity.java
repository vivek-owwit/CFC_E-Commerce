package com.vivek.loginpage.startup;
...
import com.vivek.loginpage.miscellaneous.EmptyActivity;
import com.vivek.loginpage.notification.NotificationCountSetClass;
import com.vivek.loginpage.options.CartListActivity;
import com.vivek.loginpage.options.SearchResultActivity;
import com.vivek.loginpage.options.WishlistActivity;
import com.vivek.loginpage.Iogin.ProfileActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        fragment.setArguments(bundle);
        adapter.addFragment(fragment, "HandCrafts");
        fragment = new ImageListFragment();
        bundle = new Bundle();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_item1) {
            ...
            finish();
            startActivity(new Intent(MainActivity.this, com.vivek.loginpage.Iogin.MainActivity.class));
        }else{
            startActivity(new Intent(MainActivity.this, EmptyActivity.class));
        }
